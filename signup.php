...
<body class="formback">
    ...
    <div class="form-log-sign">
        <div class="w-25 card mx-auto form-shadow border-primary">
            <div class="card-header bg-primary text-center">
                <p class="form-text lead mt-5 text-white">
                    WELCOME TO <br>
                    <img src="img/Logo-2.png" alt="Logo" class="m-auto pt-2 pb-3">
                </p>
            </div>
            <div class="card-body">
                ...
                <form action="action.php" method="post" enctype="multipart/form-data">
                    <p class="form-group">
                        ...
                        <input type="text" name="firstname" placeholder="Enter Firstname" class="form-control w-100  mt-3">
                        <input type="text" name="lastname" placeholder="Enter Lastname" class="form-control w-100  mt-3">

                        <button type="submit" name="signup" class="btn btn-outline-primary btn-block mt-5">SIGN-UP</button>
                        <hr>
